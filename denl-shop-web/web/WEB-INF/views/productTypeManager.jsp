    ...
    <script>
        ...
        function addProductType() {
            ...
            if (flag) {
                //通过校验后发送请求
                $.post( //ajax发请求
                    '${pageContext.request.contextPath}/back/product_type/add',  //参数1：请求的url
                    ...
                    function (result) {   //参数3：回调函数,result为服务器返回的结果
                        ...
                        if (result.code == "200") {
                            ...
                            layer.msg(result.msg, {
                                ...
                                //添加商品成功，刷新数据
                                location.href = '${pageContext.request.contextPath}/back/product_type/find_all?pageNum=' +
                                ${pageInfo.pageNum}
                            });
                        } else {
                            //失败
        ...
        function showProductType(id) {
            $.get(
                '${pageContext.request.contextPath}/back/product_type/findProductTypeById',
                {"id": id},
                function (result) {
                    if (result.code == "200") {
        ...
        function modifyProductTypeName() {
            ...
            if (flag) {
                ...
                $.ajax({
                    type: 'post', //请求方式
                    url: '${pageContext.request.contextPath}/back/product_type/modifyProductTypeName', //请求的url
                    ...
                    success: function (result) {     //请求回调方法
                        ...
                        if (result.code == "200") {
                            layer.msg(result.msg, {
                                ...
                                location.href = '${pageContext.request.contextPath}/back/product_type/find_all?pageNum=' +${pageInfo.pageNum};
                            });
                        } else {
                            layer.msg(result.msg, {
                                time: 1500,
        ...
        function deleteProductType() {
            $.get(
                '${pageContext.request.contextPath}/back/product_type/removeProductType',
                    ...
                    if (result.code == "200") {
                        layer.msg(result.msg, {
                            ...
                            if (${pageInfo.size > 1}) {
                                ...
                                location.href = '${pageContext.request.contextPath}/back/product_type/find_all';
                            }
                        });
                    } else {
                        layer.msg(result.msg, {
        ...
        function modifyStatus(id, btn) {
            $.post(
                '${pageContext.request.contextPath}/back/product_type/modifyProductTypeStatus',
                {'id': id},
                function (result) {
                    if (result.code == "200") {
                        layer.msg(result.msg, {
...
<div class="panel panel-default" id="userSet">
    ...
    <div class="panel-body">
        ...
        <div class="show-list text-center">
            ...
            <ul class="pagination">
                <li><a href="/back/product_type/find_all?pageNum=${pageInfo.prePage}">&laquo;</a></li>
                <c:forEach items="${pageInfo.navigatepageNums}" var="p">
                    <li><a href="/back/product_type/find_all?pageNum=${p}">${p}</a></li>
                </c:forEach>
                <li><a href="/back/product_type/find_all?pageNum=${pageInfo.nextPage}">&raquo;</a></li>
