...
<div class="row">
    <div class="container">
        <img src="${pageContext.request.contextPath}/static/images/banner1.png" class="banner" alt="">
    </div>
</div>
<!--banner end-->
...
<div class="row" style="margin-top: 50px">
    <div class="container">
        <div class="col-sm-6" style="padding: 0">
            <div class="imgShow">
                <img style="width: 400px;height: 450px" src="${product.image}" alt="">
            </div>
        </div>
        <div class="col-sm-6">
            ...
            <div class="shop">
                ...
                <div class="btn btn-primary buyBtn" onclick="buy()">立即购买</div>
            </div>
        </div>
    </div>
</div>
