...
<head>
    ...
    <style>
        ...
        .table > tbody > tr > th {
            ...
            border-bottom: 0;
            border-top: 0;
            background: #fafafa url(${pageContext.request.contextPath}/static/images/bag.gif) repeat-x;
        }
...
<div class="container" style="margin-top: 50px">
    ...
    <div class="row">
        <div class="col-sm-3" style="background: #f7f7f7">
            <ul class="list-group">
                <li class="list-group-item"><b><span style="color: #000000">全部订单</span></b>
                    <ul class="list-group second" style="margin-top: 10px">
                        <li class="list-group-item list2" onclick="showNotPaid()">
                            <span class="badge badge-secondary" style="color: #ffffff">${map.get("unpaid")}</span>
                            待付款
                        </li>
                        <li class="list-group-item list2" onclick="showNotShipped()">
                            <span class="badge" style="color: #ffffff">${map.get("notShipped")}</span>
                            待发货
                        </li>
                        <li class="list-group-item list2" onclick="showReceive()">
                            <span class="badge" style="color: #ffffff">${map.get("unReceive")}</span>
                            待收货
                        </li>
                        <li class="list-group-item list2" onclick="showFinished()">
                            <span class="badge" style="color: #ffffff">${map.get("finished")}</span>
                            待评价
                        </li>
                        <li class="list-group-item list2" onclick="showCancel()">
                            <span class="badge" style="color: #ffffff">${map.get("cancel")}</span>
                            已取消
                        </li>
                        <li class="list-group-item list2" onclick="showDelete()">
                            <span class="badge" style="color: #ffffff">${map.get("delete")}</span>
                            回收站
                        </li>
                    </ul>
                </li>
        ...
        <div class="col-sm-9">
            <table class="table table-hover orderDetail">
                ...
                <c:forEach items="${orderVoList}" var="orderVo">
                    ...
                    <tr>
                        <td colspan="7" style="text-align: left;background-color: #D0D0D0">
                        ...
                        <td colspan="7">
                            <div align="left">
                                <span class="left">总计: <b><span
                                        style="color: #000000;">&yen; ${orderVo.price}</span></b></span>
                                    <%--<span style="margin-left: 65%">--%>
                                    <%--<button class="btn btn-info">前往支付</button>--%>
                                    <%--</span>--%>
                                <c:if test="${orderVo.status == 0}">
                                    <span class="pull-right">
                                        <button class="btn btn-info" onclick="payMyOrders('${orderVo.orderNumber}')">支付订单</button>
                                        <button style="padding: 6px 12px" class="btn btn-default"
