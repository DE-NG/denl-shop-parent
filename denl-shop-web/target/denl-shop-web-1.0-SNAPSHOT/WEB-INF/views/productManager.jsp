...
<head>
    ...
    <script>
        ...
        function showProduct(id) {
            $.post(
                '${pageContext.request.contextPath}/back/product/findProductById',
                {'id': id},
                function (result) {
                    if (result.code == "200") {
        ...
        function deleteProduct(id) {
            $.post(
                '${pageContext.request.contextPath}/back/product/removeProductById',
                {'id':id},
                function (result) {
                    if (result.code == "200") {
                        console.log(result);
                        layer.msg(result.msg,{
                           ...
                           if( ${pageInfo.size > 1}){
                                ...
                                location.href = '${pageContext.request.contextPath}/back/product/findAllProduct?pageNum='+${pageInfo.pageNum};
                           }else{
                                location.href = '${pageContext.request.contextPath}/back/product/findAllProduct';
                           }
                        })
                    }else{
                        layer.msg(result.msg,{
        ...
        function modifyProduct() {
            ...
            var info=$("#info").val();
            var productTypeId=$("#pro-TypeId").val();
            if($("#pro-image")[0].files[0]!=null){
                formData.append("multipartFile",$("#pro-image")[0].files[0]);
            }
            ...
            $.ajax({
                url:'${pageContext.request.contextPath}/back/product/modifyProduct',
                data:formData,
                dataType:'json',
                type:"POST",
                async: false,
    ...
    <body>
        ...
        <div class="panel panel-default" id="userPic">
            ...
            <div class="panel-body">
                ...
                <div class="show-list text-center">
                    ...
                    <ul class="pagination">
                        <li><a href="/back/product/findAllProduct?pageNum=${pageInfo.prePage}">&laquo;</a></li>
                        <c:forEach items="${pageInfo.navigatepageNums}" var="p">
                            <li><a href="/back/product/findAllProduct?pageNum=${p}">${p}</a></li>
                        </c:forEach>
                        <li><a href="/back/product/findAllProduct?pageNum=${pageInfo.nextPage}">&raquo;</a></li>
        ...
        <div class="modal fade" tabindex="-1" id="Product">
            ...
            <div class="modal-dialog modal-lg">
                <!-- 内容声明 -->
                <form action="${pageContext.request.contextPath}/back/product/addProduct" method="post" class="form-horizontal"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <a href="javascript:;" class="file">选择文件
                                            <input type="file" name="multipartFile" id="product-image">
                                        </a>
                                    </div>
                                </div>
                                <div class="form-group">
        ...
        <div class="modal fade" tabindex="-1" id="myProduct">
            ...
            <div class="modal-dialog modal-lg">
                <!-- 内容声明 -->
                <form enctype="multipart/form-data" class="form-horizontal" id="modifyProductForm">
                    <div class="modal-content">
                        <!-- 头部、主体、脚注 -->
                        <div class="modal-header">
                            <button class="close" data-dismiss="modal">&times;</button>
                        ...
                        <div class="modal-body text-center row">
                            <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <a class="file">
                                            选择文件 <input type="file" name="multipartFile" id="pro-image">
                                        </a>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" onclick="modifyProduct()">确认</button>
                            <button class="btn btn-primary cancel" data-dismiss="modal">取消</button>
                        </div>
                    </div>
