...
<script id="welcome" type="text/html">
    ...
    <li class="dropdown">
        <a href="#" class="dropdown-toggle user-active" data-toggle="dropdown" role="button">
            <img class="img-circle" src="${pageContext.request.contextPath}/static/images/user.jpeg"
                 height="30"/>
...
<script>
    ...
    function loginByAccount() {
        ...
        if (flag) {
            $.ajax({
                url:"/front/customer/loginByAccount",
    ...
    function CustomerRegister() {
        ...
        if (valid) {
            $.ajax({
                url:'${pageContext.request.contextPath}/front/customer/register',
    ...
    function sendVerifyCode(btn) {
        var phone = $('#phone').val();
        $.ajax({
            url:'${pageContext.request.contextPath}/front/sms/sendVerifyCode',
            data:{'phone': phone},
            type:"POST",
            success:function (result) {
                if (result.code == "200") {
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="${param.num == 4 ? 'active' : ''}">
                    <a href="javascript:void(0)"
                       onclick="${sessionScope.get('customer') == null ? 'showLoginModal()' :'showCustomerInfo()'}">会员商城</a>
                </li>
                <li>
            ...
            <ul class="nav navbar-nav navbar-right" id="navbarInfo">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle user-active" data-toggle="dropdown" role="button">
                                <img class="img-circle" src="${pageContext.request.contextPath}${sessionScope.get("customer").images}"
                                     height="30"/>
                                <span class="text text-info">${sessionScope.get("customer").loginName} </span>
                                <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="/front/customer/customerCenter" >
            ...
            <form id="frmLoginByAccount" class="form-horizontal">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" type="text" placeholder="请输入手机号" name="phone">
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer" style="text-align: center">
                    ...
                    <%--<a class="btn-link">忘记密码？</a> &nbsp;--%>
                        ...
                        <button type="button" class="btn btn-info" onclick="loginByAccount()">登&nbsp;&nbsp;录</button>
                    <button type="button" class="btn btn-info" data-dismiss="modal" aria-label="Close">
                        关&nbsp;&nbsp;闭
                    </button>
                    &nbsp;&nbsp;
        ...
        <div class="modal-content" style="width: 80%">
            ...
            <form id="frmRegist" class="form-horizontal">
                ...
                <div class="modal-footer" align="center">
                    <button type="button" class="btn btn-info" onclick="CustomerRegister()">注&nbsp;&nbsp;册</button>
                    <button type="button" class="btn btn-info" onclick="resetFormDates()">重&nbsp;&nbsp;置</button>
                    <button type="button" class="btn btn-info" data-dismiss="modal" aria-label="Close">
                        关&nbsp;&nbsp;闭
                    </button>
                </div>
