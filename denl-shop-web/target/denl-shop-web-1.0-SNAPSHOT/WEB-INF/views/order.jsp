...
<head>
    ...
    <style>
        ...
        .list-add-address li {
            ...
            list-style: none;
            margin-right: 20px;
            background: url("${pageContext.request.contextPath}/static/images/address.png") no-repeat;
            height: 162px;
            width: 240px;
    ...
    <script>
        $(function () {
            ...
            $('#buildOrderModal').on('hide.bs.modal', function () {
                location.replace('${pageContext.request.contextPath}/front/order/myOrders');
            });
        });
        ...
        function commitOrders() {
            ...
            $.post(
                ...
                function (result) {
                    if (result.code == "200") {
                        //创建订单成功
                        $('#orderNo').text(result.data);
                        $('#orderNumber').val(result.data);
                    ...
                    <div class="list-add-address right">
                        <li class="col-sm-3" style="cursor: pointer;margin-top: 10px;margin-left: 5px"
                            ...
                            <div style="text-align: center;margin-top: 60px;">
                                <span><img src="${pageContext.request.contextPath}/static/images/add_cart.png"></span>
                            </div>
                        </li>
                    </div>
                </c:when>
        ...
        <tr>
            <td colspan="5" class="right">
                ...
                <a href="javascript:void(0);">
                    <button class="btn btn-default pull-right" onclick="backCart()">返回</button>
                </a>
                <input type="hidden" name="orderAddress" id="orderAddress">
                <button class="btn btn-info pull-right margin-right-15" data-toggle="modal"
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div class="orderMsg">
                    <h5 style="margin-top: 5px;font-size: 16px" class="text-info">订单提交成功！</h5>
                    <h5 class="text-info">订单号：<span id="orderNo">121314546</span></h5>
                    <h5 class="text-success">是否立即支付？</h5>
                </div>
                <div class="">
                    <input type="hidden" id="orderNumber">
                    <button style="margin-left: 5px" class="btn btn-info" onclick="payOrderFromOrder()">前往支付
                    </button>
                    <button style="padding: 6px 30px" class="btn btn-default" onclick="cancelOrder()">取消</button>
                </div>
            </div>
        </div>
    </div>
...
<%--                    </div>--%>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <script class="resources library" src="${pageContext.request.contextPath}/static/js/area.js"
                                    type="text/javascript"></script>
